...
def word_maker(num_of_let):
    ...
    for i in range(num_of_let):
        ...
        random_letter_path = random.choice(letter_list)
        letter_path =str(random.choice(letter_list))
        word.append(letter_finder(letter_path[:-4]))
        image = cv2.imread("xalil_letters/" + letter_path)
...
def write_data(number_of_image):
    ...
    for i in range(0,number_of_image):
        ...
        cv2.imwrite(f"C:/Users/ozcan/Desktop/xalil_sentence/word_{str(i)}.png", data[0])
