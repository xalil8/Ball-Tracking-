...
try:
    while True:
        ...
        # Show images
        img_xalil = cv2.cvtColor(images,cv2.COLOR_BGR2GRAY)
        threshold = cv2.adaptiveThreshold(img_xalil,255,cv2.ADAPTIVE_THRESH_GAUSSIAN_C,cv2.THRESH_BINARY,th1,th2)
